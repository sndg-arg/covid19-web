...
RUN wget -O /app/gatk.zip "https://github.com/broadinstitute/gatk/releases/download/4.1.8.0/gatk-4.1.8.0.zip" && \
    cd /app && unzip gatk.zip && rm /app/gatk.zip && mv /app/gatk-4.1.8.0 /app/gatk && rm -r /app/gatk/gatkdoc/ && \
    rm /app/gatk/gatk-package-4.1.8.0-spark.jar && rm /app/gatk/gatkPythonPackageArchive.zip
