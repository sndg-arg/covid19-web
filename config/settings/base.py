...
# sndg_covid19/)
APPS_DIR = ROOT_DIR / "sndg_covid19"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "sndg_covid19.contrib.sites.migrations"}
...
STATIC_ROOT = env("STATIC_ROOT",default= str(ROOT_DIR / "data/static"))
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sndg_covid19.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "sndg_covid19.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
